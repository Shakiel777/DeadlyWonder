...
public class SaveObject : MonoBehaviour {
    ...
    public Dictionary<string, object> GetObjectData()
    {
        ...
        else if(saveType == SaveType.Door)
        {
            ...
            data.Add("isOpen", door.isOpen);
            data.Add("isUnlocked", door.isUnlocked);
        }
        else if (saveType == SaveType.Drawer)
        {
            for(int i = 0; i < transform.childCount; i++)
            {
                if (transform.GetChild(i).GetComponent<DynamicObject>())
                {
                    ...
                    drawerData.Add("isOpen", drawer.isOpen);
                    drawerData.Add("isUnlocked", drawer.isUnlocked);
        ...
        else if (saveType == SaveType.Lever)
        {
            ...
            if (!hasDoor)
            {
                ...
                data.Add("leverAngle", lever.leverAngle);
            ...
            else
            {
                ...
                leverData.Add("leverAngle", lever.leverAngle);
                ...
                doorData.Add("isOpen", dynamicObject.isOpen);
                doorData.Add("isUnlocked", dynamicObject.isUnlocked);
        ...
        else if(saveType == SaveType.Valve)
        {
            ...
            data.Add("isRotated", valve.isRotated);
        }
        ...
        {
            data.Add("NPCData", GetComponent<ZombieAI>().GetZombieData());
        }
    ...
    public void SetObjectData (Newtonsoft.Json.Linq.JToken objectToken)
    {
        if (objectToken.HasValues)
        {
            ...
            else if (saveType == SaveType.Door)
            {
                ...
                GetComponent<DynamicObject>().isOpen = (bool)objectToken["isOpen"];
                GetComponent<DynamicObject>().isUnlocked = (bool)objectToken["isUnlocked"];
            }
            else if (saveType == SaveType.Drawer)
            {
                for (int i = 0; i < transform.childCount; i++)
                {
                    if (transform.GetChild(i).GetComponent<DynamicObject>())
                    {
                        ...
                        drawer.isOpen = (bool)drawerToken["isOpen"];
                        drawer.isUnlocked = (bool)drawerToken["isUnlocked"];
                    }
                }
            }
            else if (saveType == SaveType.Lever)
            {
                ...
                else
                {
                    ...
                    dynamicObject.isOpen = (bool)doorData["isOpen"];
                    dynamicObject.isUnlocked = (bool)doorData["isUnlocked"];
            ...
            else if (saveType == SaveType.Valve)
            {
                ...
                GetComponent<DynamicObject>().isRotated = (bool)objectToken["isRotated"];
                GetComponent<DynamicObject>().disableLoad = disableLoad;
            }
            else if (saveType == SaveType.MovableInteract)
            {
            ...
            {
                GetComponent<ZombieAI>().SetZombieData(objectToken["NPCData"]);
            }
            else if (saveType == SaveType.SaveHelper)
            {
                if (GetComponent<SaveHelper>())
